 ...
 *
 */
public class LianWxPayConfig extends CommonPayConfig{
	//公众号APP ID
	...
	//支付异步通知
	public static String NOTIFY_URL = "http://"+DOMAIN+"/order/lianwxpaynotify";
	//支付同步通知
	public static String RETURN_URL = "http://"+DOMAIN+"/order/lianwxpayreturn";
}
