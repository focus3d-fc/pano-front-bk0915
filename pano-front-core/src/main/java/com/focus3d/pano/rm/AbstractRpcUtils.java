 ...
 *
 */
public abstract class AbstractRpcUtils {
	private static final Logger log = LoggerFactory.getLogger(AbstractRpcUtils.class);
	protected static String URL_TEST = "http://172.17.13.77:8018";
